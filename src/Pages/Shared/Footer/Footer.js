...
const Footer = () => {
    return (
        ...
        <footer className="p-4 bg-rose-100 sm:p-6 dark:bg-gray-800 mt-12">
            <div className='container mx-auto'>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400"> <small>copyright @ {new Date().getFullYear()}</small><a href="https://flowbite.com" className="hover:underline">Flowbite™</a>. All Rights Reserved.
                    </span>
